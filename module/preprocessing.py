...
class PCA(object):
    def __init__(self, num_components, batch_size=100): # my change
    ...
    def apply(self, dataset, can_fit=False):
        if self._pca is None:
            ...
            #kwarg_dict = {}
            #kwarg_dict['num_components'] = self._num_components
            self._pca = pca.CovEigPCA(self.batch_size, num_components=self._num_components)
